...
void
WifiMacHeader::SetHelperAddr (Mac48Address address)
{
  m_helperaddres = address;
}
void
WifiMacHeader::SetRsh (float rsh)
{
  m_rsh = rsh;
}
void
WifiMacHeader::SetRhd(float rhd)
{
  m_rhd = rhd;
}
void
...
WifiMacHeader::SetType (WifiMacType type)
{
  switch (type)
    ...
    case WIFI_MAC_CTL_CTS:
      ...
      break;
    case WIFI_MAC_CTL_COOPRTS:
      m_ctrlType = TYPE_CTL;
      m_ctrlSubtype = SUBTYPE_CTL_COOPRTS;
      break;
    case WIFI_MAC_CTL_HTS:
      m_ctrlType = TYPE_CTL;
      m_ctrlSubtype = SUBTYPE_CTL_HTS;
      break;
...
Mac48Address
WifiMacHeader::GetHelperAddr  (void) const
{
  return m_helperaddres;
}
float
WifiMacHeader::GetRsh  (void) const
{
  return m_rsh;
}
float
WifiMacHeader::GetRhd  (void) const
{
  return m_rhd;
}
WifiMacType
  ...
  switch (m_ctrlType)
    ...
    case TYPE_CTL:
      switch (m_ctrlSubtype)
        ...
        case SUBTYPE_CTL_COOPRTS:
          return WIFI_MAC_CTL_COOPRTS;
        case SUBTYPE_CTL_HTS:
          return WIFI_MAC_CTL_HTS;
...
bool
WifiMacHeader::IsCooprts (void) const
{
  return (GetType () == WIFI_MAC_CTL_COOPRTS);
}
bool
WifiMacHeader::IsHts (void) const
{
  return (GetType () == WIFI_MAC_CTL_HTS);
}
bool
    ...
    case TYPE_CTL:
      switch (m_ctrlSubtype)
        ...
        case SUBTYPE_CTL_RTS:
          size = 2 + 2 + 6 + 6;
          break;
          // Frame Control(2)-Duration(2)-Receiver Address(6)-Transmitter Addres(6)+helperaddress(6)-rsh(4)-rhd(4);
        case SUBTYPE_CTL_COOPRTS:
          size = 2 + 2 + 6 + 6 + 6 +4 +4;
          break;
        case SUBTYPE_CTL_HTS:
