...
public:
  ...
  void SetHelperAddr (Mac48Address address);
  void SetRsh (float rsh);
  void SetRhd(float rhd);
  /**
  ...
  Mac48Address GetHelperAddr (void) const;
  float GetRsh  (void) const;
  float GetRhd  (void) const;
  /**
